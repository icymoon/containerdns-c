...
static void
db_zadd_rdata_domain( struct  domain_store *db,char *domian_name,rr_type * rr_insert)
{
...
int domaindata_srv_insert(struct  domain_store *db,char *zone_name,char *domian_name, char * host,uint16_t prio,
